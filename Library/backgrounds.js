module.exports = [
  // acolyte
  {
      ...
      "personality_trait": {
        ...
        4: "Nothing can shake your optimistic attitude",
        5: "You quote (or misquote) sacred texts and proverbs in almost every situation",
        6: "You are tolerant (or intolerant) of other faiths and respect (or condemn) the worship of other gods",
      ...
      "ideals": {
        ...
        4: "Power: You hope to one day rise to the top of my faith's religious hierarchy",
      ...
      "bond": {
        ...
        4: "Everything you do is for the common people",
      ...
      "flaws": {
        ...
        4: "You are inflexible in your thinking",
        5: "You are suspicious of strangers and expect the worst of them",
        6: "Once you pick a goal, you become obsessed with it to the detriment of everything else in your life"
      }
    },
  // urchin
  {
      ...
      "personality_trait": {
        ...
        4: "You sleep with your back to a wall or tree, with everything you own wrapped in a bundle in your arms.",
        5: "You eat like a pig and have bad manners.",
        6: "You think anyone who's nice to you is hiding evil intent.",
      ...
      "bond": {
        ...
        4: "You owe a debt you can never repay to the person who took pity on you.",
      ...
      "flaws": {
        ...
        4: "You'd rather kill someone in their sleep than fight fair.",
        5: "It's not stealing if you need it more than someone else.",
  ...
  // sailor
  {
      ...
      "personality_trait": {
        ...
        4: "You stretch the truth for the sake of a good story.",
        5: "To you, a tavern brawl is a nice way to get to know a new city.",
        6: "You never pass up a friendly wager.",
      ...
      "ideals": {
        ...
        4: "Mastery. You're a predator, and the other ships on the sea are my prey.",
      ...
      "bond": {
        ...
        4: "In a harbor town, you have a paramour whose eyes nearly stole you from the sea.",
      ...
      "flaws": {
        ...
        4: "Once you start drinking, it’s hard for you to stop.",
        5: "You can’t help but pocket loose coins and other trinkets you come across.",
        6: "Your pride will probably lead to your destruction."
      }
  },
  ...
  // sage
  {
      ...
      "personality_trait": {
        ...
        4: "There’s nothing you like more than a good mystery.",
        5: "You're willing to listen to every side of an argument before you make your own judgment.",
        6: "You... speak... slowly... when talking... to idiots,... which... almost... everyone... is... compared... to you.",
      ...
      "bond": {
        ...
        4: "Your life’s work is a series of tomes related to a specific field of lore.",
      ...
      "flaws": {
        ...
        4: "You overlook obvious solutions in favor of complicated ones.",
        5: "You speak without really thinking through your words, invariably insulting others.",
        6: "You can’t keep a secret to save your life, or anyone else’s."
      }
  },
  // criminal
  {
  ...
  // soldier
  {
      ...
      "personality_trait": {
        ...
        4: "You're full of inspiring and cautionary tales from your military experience relevant to almost every combat situation.",
        5: "You can stare down a hell hound without flinching.",
        6: "You enjoy being strong and like breaking things.",
      ...
      "bond": {
        ...
        4: "You’ll never forget the crushing defeat your company suffered or the enemies who dealt it.",
      ...
      "flaws": {
        ...
        4: "Your hatred of your enemies is blind and unreasoning.",
        5: "You obey the law, even if the law causes misery.",
        6: "You'd rather eat your armor than admit when you're wrong."
      }
  },
  // noble
  {
      ...
      "personality_trait": {
        ...
        4: "You take great pains to always look your best and follow the latest fashions.",
        5: "You don’t like to get your hands dirty, and you won’t be caught dead in unsuitable accommodations.",
        6: "Despite your noble birth, you do not place yourself above other folk. We all have the same blood.",
      ...
      "ideals": {
        ...
        4: "Power. If you can attain more power, no one will tell you what to do.",
      ...
      "bond": {
        ...
        4: "You are in love with the heir of a family that your family despises.",
      ...
      "flaws": {
        ...
        4: "You have an insatiable desire for carnal pleasures.",
        5: "In fact, the world does revolve around you.",
        6: "By your words and actions, you often bring shame to your family."
      }
  },
  ...
  // outlander
  {
      ...
      "personality_trait": {
        ...
        4: "You have a lesson for every situation, drawn from observing nature.",
        5: "You place no stock in wealthy or well-mannered folk. Money and manners won’t save you from a hungry owlbear.",
        6: "You're always picking things up, absently fiddling with them, and sometimes accidentally breaking them.",
      ...
      "bond": {
        ...
        4: "You are the last of your tribe, and it is up to you to ensure their names enter legend.",
      ...
      "flaws": {
        ...
        4: "You are slow to trust members of other races, tribes, and societies.",
        5: "Violence is your answer to almost any challenge.",
        6: "Don’t expect you to save those who can’t save themselves. It is nature’s way that the strong thrive and the weak perish."
      }
  },
  // charlatan
  {
      ...
      "personality_trait": {
        ...
        4: "You're a born gambler who can't resist taking a risk for a potential payoff.",
        5: "You lie about almost everything, even when there’s no good reason to.",
        6: "Sarcasm and insults are your weapons of choice.",
      ...
      "ideals": {
        ...
        4: "Creativity. You never run the same con twice.",
      ...
      "bond": {
        ...
        4: "You come from a noble family, and one day you’ll reclaim your lands and title from those who stole them from you.",
      ...
      "flaws": {
        ...
        4: "You're too greedy for your own good. You can’t resist taking a risk if there’s money involved.",
        5: "You can’t resist swindling people who are more powerful than you.",
  ...
  // folk hero
  {
      ...
      "personality_trait": {
        ...
        4: "You have a strong sense of fair play and always try to find the most equitable solution to arguments.",
        5: "You're confident in your own abilities and do what you can to instill confidence in others.",
        6: "Thinking is for other people. You prefer action.",
      ...
      "ideals": {
        ...
        4: "Might. If you become strong, you can take what you want—what you deserve.",
      ...
      "bond": {
        ...
        4: "Your tools are symbols of your past life, and you carry them so that you will never forget your roots.",
      ...
      "flaws": {
        ...
        4: "You have a weakness for the vices of the city, especially hard drink.",
        5: "Secretly, you believe that things would be better if you were a tyrant lording over the land.",
  ...
  // entertainer
  {
      ...
      "personality_trait": {
        ...
        4: "Nobody stays angry at you or around you for long, since you can defuse any amount of tension.",
        5: "You love a good insult, even one directed at you.",
        6: "You get bitter if you're not the centre of attention.",
      ...
      "ideals": {
        ...
        4: "Greed. You're only in it for the money and fame.",
      ...
      "bond": {
        ...
        4: "You idolize a hero of the old tales and measure your deeds against that person’s.",
      ...
      "flaws": {
        ...
        4: "You once satirized a noble who still wants your head. It was a mistake that you will likely repeat.",
        5: "You have trouble keeping your true feelings hidden. Your sharp tongue lands you in trouble.",
  ...
  // hermit
  {
      ...
      "personality_trait": {
        ...
        4: "You feel tremendous empathy for all who suffer.",
        5: "You're oblivious to etiquette and social expectations.",
        6: "You connect everything that happens to you to a grand, cosmic plan.",
      ...
      "bond": {
        ...
        4: "You entered seclusion because you loved someone you could not have.",
      ...
      "flaws": {
        ...
        4: "You let your need to win arguments overshadow friendships and harmony.",
        5: "You’d risk too much to uncover a lost bit of knowledge.",
        6: "You like keeping secrets and won’t share them with anyone."
      }
  },
  // guild artisan
  {
      ...
      "personality_trait": {
        ...
        4: "You're full of witty aphorisms and have a proverb for every occasion.",
        5: "You're rude to people who lack your commitment to hard work and fair play.",
        6: "You like to talk at length about your profession.",
      ...
      "ideals": {
        ...
        4: "Greed. You're only in it for the money.",
      ...
      "bond": {
        ...
        4: "You pursue wealth to secure someone’s love.",
      ...
      "flaws": {
        ...
        4: "You're never satisfied with what you have — you always want more.",
        5: "You would kill to acquire a noble title.",
