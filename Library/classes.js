module.exports = [
  // barbarian
  {
    ...
    "stat_weighting": ['Strength', 'Constitution', 'Dexterity', 'Intelligence', 'Wisdom', 'Charisma'],
    "hit_die": 12,
  ...
  // bard
  {
    ...
    "stat_weighting": ['Charisma', 'Wisdom', 'Dexterity', 'Intelligence', 'Constitution', 'Strength'],
    "hit_die": 8,
    "starting_proficiencies": [
      "Light Armour",
      "Simple Weapons",
  ...
  {
    "name": "Cleric",
    "description": "Clerics are intermediaries between the mortal world and the distant planes of the gods. As varied as the gods they serve, clerics Strengthive to embody the handiwork of their deities. No ordinary priest, a cleric is imbued with divine magic.",
    "primary_ability": "Wisdom",
    "stat_weighting": ['Wisdom', 'Constitution', 'Strength', 'Intelligence', 'Dexterity', 'Charisma'],
    "hit_die": 8,
    "starting_proficiencies": [
      "Light Armour",
      "Medium Armour",
  ...
  // druid
  {
    ...
    "primary_ability": "Wisdom",
    "stat_weighting": ['Wisdom', 'Constitution', 'Dexterity', 'Intelligence', 'Strength', 'Charisma'],
    "hit_die": 8,
    "starting_proficiencies": [
      "Light Armour",
  ...
  // fighter
  {
    ...
    "primary_ability": "Strength",
    "stat_weighting": ['Strength', 'Dexterity', 'Constitution', 'Charisma', 'Wisdom', 'Intelligence'],
    "hit_die": 10,
    "starting_proficiencies": [
      "Light Armour",
      "Medium Armour",
  ...
  // monk
  {
    ...
    "stat_weighting": ['Dexterity', 'Wisdom', 'Constitution', 'Strength', 'Intelligence', 'Charisma'],
    "hit_die": 8,
    "starting_proficiencies": [
      "Simple Weapons",
      "Shortswords"
  ...
  // paladin
  {
    ...
    "primary_ability": "Charisma",
    "stat_weighting": ['Charisma', 'Strength', 'Constitution', 'Wisdom', 'Dexterity', 'Intelligence'],
    "hit_die": 10,
    "starting_proficiencies": [
      "Light Armour",
      "Medium armour",
  ...
  // ranger
  {
    ...
    "primary_ability": "Dexterity",
    "stat_weighting": ['Dexterity', 'Wisdom', 'Intelligence', 'Constitution', 'Strength', 'Charisma'],
    "hit_die": 10,
    "starting_proficiencies": [
      "Light Armour",
      "Medium armour",
  ...
  {
    "name": "Rogue",
    "description": "Rogues rely on skill, stealth, and their foes’ vulnerabilities to get the upper hand in any situation. They have a knack for finding the solution to just about any problem, demonStrengthating a resourcefulness and versatility that is the cornerstone of any successful adventuring party.",
    "primary_ability": "Dexterity",
    "stat_weighting": ['Dexterity', 'Intelligence', 'Charisma', 'Constitution', 'Wisdom', 'Strength'],
    "hit_die": 8,
    "starting_proficiencies": [
      "Light Armour",
      "Simple Weapons",
  ...
  // sorcerer
  {
    ...
    "primary_ability": "Charisma",
    "stat_weighting": ['Charisma', 'Constitution', 'Wisdom', 'Intelligence', 'Dexterity', 'Strength'],
    "hit_die": 6,
    "starting_proficiencies": [
      "Daggers",
      "Darts",
  ...
  // wizard
  {
    ...
    "stat_weighting": ['Intelligence', 'Constitution', 'Wisdom', 'Dexterity', 'Charisma', 'Strength'],
    "hit_die": 6,
    "starting_proficiencies": [
      "Daggers",
      "Darts",
